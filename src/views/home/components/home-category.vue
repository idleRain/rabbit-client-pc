  ...
  <div class="home-category" @mouseleave="categoryId = ''">
    <ul class="menu">
      <li v-for="item in category.list"
        ...
        <template v-else>
          <!-- 骨架屏 -->
          <Skeleton :width="70" :height="18" style="margin-right: 5px" bg="rgba(255,255,255,0.2)" animated/>
          <Skeleton :width="40" :height="18" style="margin-right: 5px" bg="rgba(255,255,255,0.2)" animated/>
        </template>
      </li>
    </ul>
    <!--  弹层  -->
